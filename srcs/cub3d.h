...
/*   Updated: 2020/01/19 21:45:03 by adda-sil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_draw_renderer(t_game *game, t_ipos pos, unsigned int color);
...
void			ft_draw_objects(t_game *g, int c, t_ray *r, t_drawer *d);
void			ft_draw_object(t_game *g, int c, t_object *o, t_drawer *d);
...
void			ft_draw_sprite(t_game *g, t_sprite *s, t_dpos d, double r);
...
void			ft_draw_minimap_square(t_game *g, t_ipos pos, unsigned int c);
void			to_intpos(t_ipos *ret, t_dpos pos);
int				ft_generate_megamap(t_game *game);
void			ft_draw_megamap(t_game *game);
void			ft_update_megamap(t_game *game, t_ray *ray);
...
int				ft_print_defined_err(char *txt);
